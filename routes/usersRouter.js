...
const { getMe } = require('../controllers/userController'); // Importing user-related controllers
const protect = require('../middlewares/auth'); // Importing authentication middleware
